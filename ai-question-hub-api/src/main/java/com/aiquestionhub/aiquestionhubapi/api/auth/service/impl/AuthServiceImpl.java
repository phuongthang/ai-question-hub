package com.aiquestionhub.aiquestionhubapi.api.auth.service.impl;
...
import com.aiquestionhub.aiquestionhubapi.api.auth.repository.PasswordResetTokenRepository;
...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthResponse register(UserRegisterRequest request) {
        ...
        user.setUserCode(UUID.randomUUID().toString().replace("-", "").substring(0, 12).toUpperCase());
